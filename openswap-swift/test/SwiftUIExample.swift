/**
 * SwiftUI Example for Openswap Swift bindings
 * 
 * Demonstrates how to integrate openswap into a SwiftUI application
...
class WalletViewModel: ObservableObject {
    ...
    func performSwap(amount: UInt64) async {
        ...
        do {
            ...
            let report = try taker?.doOpenswap(swapParams: params)
