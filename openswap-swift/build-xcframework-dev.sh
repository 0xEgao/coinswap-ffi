...
NEW_HEADER_DIR="../openswap-swift/Sources/OpenswapFFI/include"
PROFILE_DIR="debug"
...
IPHONEOS_DEPLOYMENT_TARGET=14.0 cargo build --package openswap-ffi --target "$IOS_SIM_TARGET"
IPHONEOS_DEPLOYMENT_TARGET=14.0 cargo build --package openswap-ffi --target "$IOS_DEVICE_TARGET"
