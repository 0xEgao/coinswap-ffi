...
/* eslint-disable */
export type PositiveSats = number & { readonly __positiveSats: unique symbol }
...
export declare class Taker {
  ...
  sendToAddress(address: string, amount: PositiveSats, feeRate?: number | undefined | null, manuallySelectedOutpoints?: Array<OutPoint> | undefined | null): Txid
  /** Get wallet balances */
