...
mkdir -p ../openswap-kotlin/lib/src/main/jniLibs/$RESOURCE_DIR_ARM64_V8A/
mkdir -p ../openswap-kotlin/lib/src/main/jniLibs/$RESOURCE_DIR_X86_64/
cp ./target/$COMPILATION_TARGET_ARM64_V8A/release-smaller/$LIB_NAME ../openswap-kotlin/lib/src/main/jniLibs/$RESOURCE_DIR_ARM64_V8A/
cp ./target/$COMPILATION_TARGET_X86_64/release-smaller/$LIB_NAME ../openswap-kotlin/lib/src/main/jniLibs/$RESOURCE_DIR_X86_64/

cargo run --bin uniffi-bindgen generate --library ./target/$COMPILATION_TARGET_ARM64_V8A/release-smaller/$LIB_NAME --language kotlin --out-dir ../openswap-kotlin/lib/src/main/kotlin/ --no-format
cp ./target/$COMPILATION_TARGET_ARM64_V8A/release-smaller/libopenswap_ffi.d ../openswap-kotlin/lib/src/main/jniLibs/$RESOURCE_DIR_ARM64_V8A/
cp ./target/$COMPILATION_TARGET_X86_64/release-smaller/libopenswap_ffi.d ../openswap-kotlin/lib/src/main/jniLibs/$RESOURCE_DIR_X86_64/