...
mkdir -p ../openswap-kotlin/lib/src/main/jniLibs/$RESOURCE_DIR_ARMEABI_V7A/
cp ./target/$COMPILATION_TARGET_ARMEABI_V7A/release-smaller/$LIB_NAME ../openswap-kotlin/lib/src/main/jniLibs/$RESOURCE_DIR_ARMEABI_V7A/

cargo run --bin uniffi-bindgen generate --library ./target/$COMPILATION_TARGET_ARMEABI_V7A/release-smaller/$LIB_NAME --language kotlin --out-dir ../openswap-kotlin/lib/src/main/kotlin/ --no-format
cp ./target/$COMPILATION_TARGET_ARMEABI_V7A/release-smaller/libopenswap_ffi.d ../openswap-kotlin/lib/src/main/jniLibs/$RESOURCE_DIR_ARMEABI_V7A/
