...
cargo run --bin uniffi-bindgen generate --library ./target/$COMPILATION_TARGET_X86_64/debug/$LIB_NAME --language kotlin --out-dir ../openswap-kotlin/lib/src/main/kotlin/ --no-format
cp ./target/$COMPILATION_TARGET_X86_64/debug/$LIB_NAME ../openswap-kotlin/lib/src/main/jniLibs/$RESOURCE_DIR_X86_64
cp ./target/$COMPILATION_TARGET_X86_64/debug/libopenswap_ffi.d ../openswap-kotlin/lib/src/main/jniLibs/$RESOURCE_DIR_X86_64/
cp ./target/debug/uniffi-bindgen ../openswap-kotlin/lib/src/main/jniLibs/$RESOURCE_DIR_X86_64
cp ./target/debug/uniffi-bindgen.d ../openswap-kotlin/lib/src/main/jniLibs/$RESOURCE_DIR_X86_64
