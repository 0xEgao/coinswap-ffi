...
mkdir -p \
  ...
  "$TMP_DIR/src/org/openswap/reactnative"
...
cat > "$TMP_DIR/src/org/openswap/reactnative/NativeOpenswapReactNativeSpec.java" <<'JAVA'
package org.openswap.reactnative;
import com.facebook.react.bridge.NativeModule;
import com.facebook.react.bridge.ReactApplicationContext;
public abstract class NativeOpenswapReactNativeSpec implements NativeModule {
  private final ReactApplicationContext context;

  protected NativeOpenswapReactNativeSpec(ReactApplicationContext reactContext) {
...
javac -d "$TMP_DIR/out" \
  ...
  "$TMP_DIR/src/org/openswap/reactnative/NativeOpenswapReactNativeSpec.java" \
  "$ROOT_DIR/android/src/main/java/org/openswap/reactnative/OpenswapReactNativeModule.java" \
  "$ROOT_DIR/android/src/main/java/org/openswap/reactnative/OpenswapReactNativePackage.java"
