...
function downloadBinaryArtifacts() {
  ...
  const iosFrameworkPath = path.join(packageRoot, 'ios/openswap_ffi.xcframework')
  ...
  console.warn(
    'Openswap React Native native artifacts are not present yet. Run the package build scripts before creating an Expo project or release build.'
  )
}
